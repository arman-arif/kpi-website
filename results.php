...
$page_title = ($lang == 'en')?"Results":"ফলাফল";

$infos = $opr->getRSortedRecord("results", "year");
			...
			<div class="table-responsive table-dark">
				<table class="table table-striped table-bordered table-hover">
					...
					<tr style="font-weight: bold">
                        ...
                        <th class="text-center"><?= ($lang == 'en')?"Year":"বছর" ?></th>
					...
					<?php
						...
						foreach ($infos as $info):
							...
							<tr class="<?php echo ($i%2==0)?"even":"odd"; ?>" style="color: #303030">
								...
								<td width="20%" style="text-align: center;"><?= $info['year'] ?></td>
								<td class="text-center">
									<a href="uploads/files/results/<?= $info['file'] ?>" class="my-btn" target="_blank"><span class="ti-new-window"></span></a>&ensp;
									<a href="uploads/files/results/<?= $info['file'] ?>" class="my-btn green-btn" download="result_<?= $info['semester']."_semester_".$info['year'] ?>"><span class="ti-download"> <?= ($lang == 'en')?"Download":"ডাউনলোড" ?></span></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
