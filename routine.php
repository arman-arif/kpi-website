...
$page_title = ($lang == 'en')?"Routine":"রুটিন";

$infos = $opr->getRSortedRecord("routine", "dept");
			...
			<div class="table-responsive table-dark">
				<table class="table table-striped table-bordered table-hover">
					...
					<tr style="font-weight: bold">
						...
						<th class="text-center"><?= ($lang == 'en')?"Shift":"শিফট" ?></th>
					...
					<?php
						...
						foreach ($infos as $info):
							...
							<tr class="<?php echo ($i%2==0)?"even":"odd"; ?>" style="color: #303030">
								...
								<td style="text-align: center;"><?php if ($lang == 'en'){
										echo $info['semester'];
									} else {
								...
								<td style="text-align: center;"><?php
									...
									?> <?= ($lang == 'en')?"Shift":"শিফট" ?></td>
								<td style="text-align: center;"><?= $info['regulation'] ?></td>
								<td class="text-center">
									<a href="uploads/files/routine/<?= $info['file'] ?>" class="my-btn" target="_blank"><span class="ti-new-window"></span></a>&ensp;
									<a href="uploads/files/routine/<?= $info['file'] ?>" class="my-btn green-btn"
									   download="routine_<?= $info['semester']."_semester_".$info['shift']."_shift_".$info['regulation'] ?>">
										<span class="ti-download"> <?= ($lang == 'en')?"Download":"ডাউনলোড" ?></span></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
