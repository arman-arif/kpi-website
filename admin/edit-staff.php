...
if (isset($_POST['name'])){
    ...
    if (empty($data['description']) || empty($data['academics']) || empty($data['address'])){
        ...
        if (!empty($_FILES['image']['name'])){
            $image = $oup->uploadImage($_FILES, "image", "staffs");
            if ($image != false){
                $odl->deleteImage($r_info->image, "staffs");
            }
        }
        ...
        if ($image != false){
            $odb->updateData('staffs', $data, $id);
            header("location: view-staff-details.php?id=$id");
        }
    }
}
                    ...
                    <div class="row m-4">
                        <div class="col-lg-12">
                            <div class="mx-auto text-center">
                                <img src="../uploads/staffs/<?= $r_info->image ?>" width="150" style="margin: 0 auto;">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label>Photo <small>(Change Photo)</small></label>
